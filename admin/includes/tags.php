...
class tag
{
	...
	public function read_50()
	{
		$sql = "SELECT * FROM $this->table join blog_post on $this->table.n_blog_post_id = blog_post.n_blog_post_id order by n_blog_post_views DESC limit 50 ";
